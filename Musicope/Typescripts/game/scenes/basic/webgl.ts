module Musicope.Game.Scenes.BasicFns {
  ...
  export class WebGL {
    ...
    private initShaders() {
      ...
      var vertexShader = o.getShader("Typescripts/game/scenes/basic/_assets/vertex.glsl");
      var fragmentShader = o.getShader("Typescripts/game/scenes/basic/_assets/fragment.glsl");
