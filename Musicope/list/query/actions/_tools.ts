module Musicope.List.QueryFns.Actions.Tools {
  ...
  export function colorSongsByQueries(songs: ISong[], queries: string[]) {
    var coloredSongs: ISong[] = songs.map((song) => {
  ...
  export function filterSongsByQueries(songs: ISong[], queries: string[]) {
