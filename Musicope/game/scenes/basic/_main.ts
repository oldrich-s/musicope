module Musicope.Game.Scenes {
  ...
  export class Basic implements IScene {
    ...
    private webgl: BasicFns.WebGL;

    private pausedColor: Int32Array;
    private unpausedColor: Int32Array;

    constructor(private song: Songs.ISong, public params: Params.IParams) {
      var o = this;
    ...
    private setupWebGL() {
      ...
      o.webgl = new BasicFns.WebGL(o.canvas, attributes);
    }
    ...
    private static concat(arrays: Float32Array[]) {
      var result = (() => {
        var length = 0;
