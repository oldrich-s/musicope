define(["require", "exports", "./drawScene", "./webgl"], function(require, exports, __drawScene__, __webgl__) {
    ...
    var Basic = (function () {
        function Basic(parser, params) {
            this.parser = parser;
            this.params = params;
            this.pressedNotes = new Int32Array(127);
            var o = this;
            o.parser = parser;
            o.setBackgrColors();
        ...
        Basic.prototype.setPressedNote = function (noteId) {
            this.pressedNotes[noteId] = 1;
        };
        Basic.prototype.unsetPressedNote = function (noteId) {
            this.pressedNotes[noteId] = 0;
        };
        Basic.prototype.unsetAllPressedNotes = function () {
