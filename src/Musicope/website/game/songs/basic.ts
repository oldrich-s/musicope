module Musicope.Game.Songs {
  ...
  export class Basic implements ISong {
    ...
    constructor(midi: Uint8Array, private params: Params.IParams) {
      var o = this;
    ...
    private setParamsFromParser(parser: IParser) {
      var o = this;
    ...
    private getSceneNote(noteOn: INote, noteOff: INote) {
      return {
        timeOn: noteOn.time,
