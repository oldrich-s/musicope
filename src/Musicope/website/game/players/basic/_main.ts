module Musicope.Game.Players.Basic {
  ...
  export class Basic implements IPlayer {
    ...
    constructor(private device: IDevice, private song: ISong, private metronome: Metronomes.IMetronome,
      private scene: IScene, private params: Params.IParams) {
      o = this;
    ...
    private getIdBelowCurrentTime(notes: INote[]) {
      if (notes.length > 0) {
